...
import net.mcreator.superiorstructures.procedures.LichenageProcedure;

import java.util.Set;
import java.util.List;
import org.checkerframework.checker.units.qual.Luminance;

public class LushLichen2Feature extends Feature<NoneFeatureConfiguration> {
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(Level.OVERWORLD);
	private final List<Block> base_blocks;
	private StructureTemplate template = null;

	public LushLichen2Feature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(Blocks.CLAY, Blocks.STONE, Blocks.DEEPSLATE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.AIR);
	}
