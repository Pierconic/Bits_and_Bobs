...
public class AlternatePortalFeature extends Feature<NoneFeatureConfiguration> {
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(Level.NETHER);
	private StructureTemplate template = null;

	public AlternatePortalFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if ((context.random().nextInt(1000000) + 1) <= 40000) { //previously...
