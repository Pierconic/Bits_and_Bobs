...
import net.mcreator.superiorstructures.procedures.SpecterDeathProcedure;
import net.mcreator.superiorstructures.procedures.IncrementLifetimeProcedure;
...
public class SpecterEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Integer> DATA_Lifetime = SynchedEntityData.defineId(SpecterEntity.class, EntityDataSerializers.INT);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "specter");
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.vex.death"));
	}
	...
	@Override
 	public void baseTick() {
      super.baseTick();
      IncrementLifetimeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
  ...
  public void tick() {
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			if (this.isDeadOrDying()) {
				return event.setAndContinue(RawAnimation.begin().thenPlay("vanish"));
			}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			...
			SpecterDeathProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		}
	}
