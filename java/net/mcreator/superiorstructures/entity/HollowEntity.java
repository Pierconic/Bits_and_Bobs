...
import net.mcreator.superiorstructures.procedures.HollowUpdateTickProcedure;
import net.mcreator.superiorstructures.procedures.HollowLeapTestProcedure;
import net.mcreator.superiorstructures.procedures.HollowDeathProcedure;
import net.mcreator.superiorstructures.procedures.HollowBurrowProcedure;
import net.mcreator.superiorstructures.procedures.BurrowConditionProcedure;
...
public class HollowEntity extends Monster implements GeoEntity {
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:hollow.step")), 0.15f, 1);
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:hollow.hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:hollow.death"));
	}
