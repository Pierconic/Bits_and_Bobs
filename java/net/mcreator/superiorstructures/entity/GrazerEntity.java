...
import net.mcreator.superiorstructures.procedures.GrazerTeleportProcedure;
import net.mcreator.superiorstructures.procedures.GrazerEntityIsHurtProcedure;
import net.mcreator.superiorstructures.procedures.GrazerEntityDiesProcedure;
...
public class GrazerEntity extends PathfinderMob implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.5, Ingredient.of(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().asItem()), false));
