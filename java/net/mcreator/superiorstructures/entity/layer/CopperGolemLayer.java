...
public class CopperGolemLayer extends GeoRenderLayer<CopperGolemEntity> {
	...
	public CopperGolemLayer(GeoRenderer<CopperGolemEntity> entityRenderer) {
		super(entityRenderer);
	}

	@Override
	public void render(PoseStack poseStack, CopperGolemEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
