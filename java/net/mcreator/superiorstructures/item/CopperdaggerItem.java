...
import net.mcreator.superiorstructures.procedures.CopperDaggerHitProcedure;
...
public class CopperdaggerItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		CopperDaggerHitProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity, itemstack);
		return retval;
	}
