...
import net.mcreator.superiorstructures.procedures.FireBoltGrenadeProcedure;
import net.mcreator.superiorstructures.init.SuperiorstructuresModItems;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class FiringBoltCatalystItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(SuperiorstructuresModItems.BOLT_CATALYST.get(), new OptionalDispenseItemBehavior() {
			public ItemStack execute(BlockSource blockSource, ItemStack stack) {
				...
				FireBoltGrenadeProcedure.execute(world, x, y, z, direction);
				if (success)
					itemstack.shrink(1);
				return itemstack;
			}
