...
import net.mcreator.superiorstructures.procedures.FireLightningSpearProcedure;
import net.mcreator.superiorstructures.init.SuperiorstructuresModItems;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class FiringLightningSpearItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(SuperiorstructuresModItems.LIGHTNING_SPEAR.get(), new OptionalDispenseItemBehavior() {
			public ItemStack execute(BlockSource blockSource, ItemStack stack) {
				...
				FireLightningSpearProcedure.execute(world, x, y, z, direction);
				if (success)
					itemstack.shrink(1);
				return itemstack;
			}
