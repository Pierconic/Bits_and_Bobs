...
import net.mcreator.superiorstructures.procedures.FireWeatheredSpearProcedure;
import net.mcreator.superiorstructures.init.SuperiorstructuresModItems;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class FiringWeatheredSpearItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(SuperiorstructuresModItems.WEATHERED_COPPER_SPEAR.get(), new OptionalDispenseItemBehavior() {
			public ItemStack execute(BlockSource blockSource, ItemStack stack) {
				...
				FireWeatheredSpearProcedure.execute(world, x, y, z, direction);
				if (success)
					itemstack.shrink(1);
				return itemstack;
			}
