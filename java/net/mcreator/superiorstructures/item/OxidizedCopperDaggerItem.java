...
import net.mcreator.superiorstructures.procedures.OxidizedCopperDaggerHitProcedure;
import net.mcreator.superiorstructures.procedures.KnifeBlockageProcedure;

public class OxidizedCopperDaggerItem extends SwordItem {
	...
	public OxidizedCopperDaggerItem() {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		OxidizedCopperDaggerHitProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity, itemstack);
		return retval;
	}
