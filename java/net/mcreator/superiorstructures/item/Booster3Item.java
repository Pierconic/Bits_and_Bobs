...
import net.mcreator.superiorstructures.procedures.BoostJumpsReset3Procedure;
...
public abstract class Booster3Item extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 3);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorstructures:booster3_"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorstructures:booster_3"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public Booster3Item(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Chestplate extends Booster3Item {
		public Chestplate() {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				BoostJumpsReset3Procedure.execute(world, entity, itemstack);
			}
		}
	}

	public static class Boots extends Booster3Item {
		public Boots() {
