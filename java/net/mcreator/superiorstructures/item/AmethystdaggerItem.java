...
import net.mcreator.superiorstructures.procedures.AmethystDaggerHitProcedure;
...
public class AmethystdaggerItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		AmethystDaggerHitProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity, itemstack);
		return retval;
	}
