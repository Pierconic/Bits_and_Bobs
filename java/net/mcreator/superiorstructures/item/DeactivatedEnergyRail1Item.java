...
import net.mcreator.superiorstructures.procedures.RailChargedProcedure;

import java.util.List;

public class DeactivatedEnergyRail1Item extends Item {
	public DeactivatedEnergyRail1Item() {
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity, InteractionHand hand) {
		...
		RailChargedProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
}
