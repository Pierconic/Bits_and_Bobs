...
import net.mcreator.superiorstructures.procedures.WeatheredCopperDaggerHitProcedure;
import net.mcreator.superiorstructures.procedures.KnifeBlockageProcedure;

public class WeatheredCopperDaggerItem extends SwordItem {
	...
	public WeatheredCopperDaggerItem() {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		WeatheredCopperDaggerHitProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity, itemstack);
		return retval;
	}
