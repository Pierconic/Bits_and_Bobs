...
import net.mcreator.superiorstructures.procedures.PrismaticDaggerHitProcedure;
import net.mcreator.superiorstructures.procedures.KnifeBlockageProcedure;

public class PrismaticDaggerItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		PrismaticDaggerHitProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity, itemstack);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A72+3-6 Piercing Damage"));
	}
}
