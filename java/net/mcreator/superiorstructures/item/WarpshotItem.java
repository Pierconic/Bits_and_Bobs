...
import net.mcreator.superiorstructures.procedures.WarpshotFiredProcedure;
import net.mcreator.superiorstructures.procedures.RemainingChargeProcedure;

import java.util.List;

public class WarpshotItem extends Item {
	public WarpshotItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		WarpshotFiredProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
