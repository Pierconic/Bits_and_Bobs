...
public class Modelcopper_golem_powered<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("superiorstructures", "modelcopper_golem_powered"), "main");
	public final ModelPart MainBody;
	public final ModelPart Rod;

	public Modelcopper_golem_powered(ModelPart root) {
