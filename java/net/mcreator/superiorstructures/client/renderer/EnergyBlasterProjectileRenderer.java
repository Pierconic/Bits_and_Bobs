...
public class EnergyBlasterProjectileRenderer extends EntityRenderer<EnergyBlasterProjectileEntity> {
	...
	public EnergyBlasterProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelbeam_model(context.bakeLayer(Modelbeam_model.LAYER_LOCATION));
	}

	@Override
	public void render(EnergyBlasterProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(EnergyBlasterProjectileEntity entity) {
		return texture;
	}
}
