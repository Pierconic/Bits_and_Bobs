...
public class EnergyBlaster2ProjectileRenderer extends EntityRenderer<EnergyBlaster2ProjectileEntity> {
	...
	public EnergyBlaster2ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelbeam_model(context.bakeLayer(Modelbeam_model.LAYER_LOCATION));
	}

	@Override
	public void render(EnergyBlaster2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(EnergyBlaster2ProjectileEntity entity) {
		return texture;
	}
}
