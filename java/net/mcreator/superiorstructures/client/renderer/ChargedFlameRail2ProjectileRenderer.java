...
public class ChargedFlameRail2ProjectileRenderer extends EntityRenderer<ChargedFlameRail2ProjectileEntity> {
	...
	public ChargedFlameRail2ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(ChargedFlameRail2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(ChargedFlameRail2ProjectileEntity entity) {
		return texture;
	}
}
