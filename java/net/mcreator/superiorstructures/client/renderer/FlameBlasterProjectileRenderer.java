...
public class FlameBlasterProjectileRenderer extends EntityRenderer<FlameBlasterProjectileEntity> {
	...
	public FlameBlasterProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelbeam_model(context.bakeLayer(Modelbeam_model.LAYER_LOCATION));
	}

	@Override
	public void render(FlameBlasterProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FlameBlasterProjectileEntity entity) {
		return texture;
	}
}
