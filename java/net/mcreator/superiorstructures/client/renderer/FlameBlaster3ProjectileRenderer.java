...
public class FlameBlaster3ProjectileRenderer extends EntityRenderer<FlameBlaster3ProjectileEntity> {
	...
	public FlameBlaster3ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelbeam_model(context.bakeLayer(Modelbeam_model.LAYER_LOCATION));
	}

	@Override
	public void render(FlameBlaster3ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FlameBlaster3ProjectileEntity entity) {
		return texture;
	}
}
