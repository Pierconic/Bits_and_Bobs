...
public class FrostRail2ProjectileRenderer extends EntityRenderer<FrostRail2ProjectileEntity> {
	...
	public FrostRail2ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(FrostRail2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FrostRail2ProjectileEntity entity) {
		return texture;
	}
}
