...
public class FrostRail1ProjectileRenderer extends EntityRenderer<FrostRail1ProjectileEntity> {
	...
	public FrostRail1ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(FrostRail1ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FrostRail1ProjectileEntity entity) {
		return texture;
	}
}
