...
public class FlameRail1ProjectileRenderer extends EntityRenderer<FlameRail1ProjectileEntity> {
	...
	public FlameRail1ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(FlameRail1ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FlameRail1ProjectileEntity entity) {
		return texture;
	}
}
