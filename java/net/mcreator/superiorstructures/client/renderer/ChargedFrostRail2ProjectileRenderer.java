...
public class ChargedFrostRail2ProjectileRenderer extends EntityRenderer<ChargedFrostRail2ProjectileEntity> {
	...
	public ChargedFrostRail2ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(ChargedFrostRail2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(ChargedFrostRail2ProjectileEntity entity) {
		return texture;
	}
}
