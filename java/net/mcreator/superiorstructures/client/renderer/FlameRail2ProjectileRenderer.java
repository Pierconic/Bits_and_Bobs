...
public class FlameRail2ProjectileRenderer extends EntityRenderer<FlameRail2ProjectileEntity> {
	...
	public FlameRail2ProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelorb_model(context.bakeLayer(Modelorb_model.LAYER_LOCATION));
	}

	@Override
	public void render(FlameRail2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FlameRail2ProjectileEntity entity) {
		return texture;
	}
}
