...
import net.mcreator.superiorstructures.procedures.ReturnPersistenceProcedure;
import net.mcreator.superiorstructures.procedures.ReturnMechanicalProcedure;
import net.mcreator.superiorstructures.procedures.ReturnDisplayNameProcedure;
import net.mcreator.superiorstructures.procedures.ReturnCurrentReplacementProcedure;
import net.mcreator.superiorstructures.procedures.ReturnCurrentFunctionProcedure;
import net.mcreator.superiorstructures.network.FlavorInterfaceButtonMessage;
...
public class FlavorInterfaceScreen extends AbstractContainerScreen<FlavorInterfaceMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("superiorstructures:textures/screens/flavor_interface.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/sigilindicator.png"), this.leftPos + 13, this.topPos + 167, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/villager_cord_negative.png"), this.leftPos + 29, this.topPos + 125, 0, 0, 11, 11, 11, 11);

		guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/villager_cord_negative.png"), this.leftPos + 29, this.topPos + 147, 0, 0, 11, 11, 11, 11);

		if (ReturnPersistenceProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/villager_cord.png"), this.leftPos + 29, this.topPos + 124, 0, 0, 11, 11, 11, 11);
		}
		if (ReturnMechanicalProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/villager_cord.png"), this.leftPos + 29, this.topPos + 147, 0, 0, 11, 11, 11, 11);
		}
	...
	public void init() {
		super.init();
		HackInput = new EditBox(this.font, this.leftPos + 9, this.topPos + 50, 118, 18, Component.translatable("gui.superiorstructures.flavor_interface.HackInput")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.HackInput").getString());
				else
					setSuggestion(null);
			}
		...
		HackInput.setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.HackInput").getString());
		guistate.put("text:HackInput", HackInput);
		this.addWidget(this.HackInput);
		ReplacementInput = new EditBox(this.font, this.leftPos + 33, this.topPos + 166, 118, 18, Component.translatable("gui.superiorstructures.flavor_interface.ReplacementInput")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.ReplacementInput").getString());
				else
					setSuggestion(null);
			}
		...
		ReplacementInput.setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.ReplacementInput").getString());
		guistate.put("text:ReplacementInput", ReplacementInput);
		this.addWidget(this.ReplacementInput);
		DelayInput = new EditBox(this.font, this.leftPos + 136, this.topPos + 50, 25, 18, Component.translatable("gui.superiorstructures.flavor_interface.DelayInput")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.DelayInput").getString());
				else
					setSuggestion(null);
			}
		...
		DelayInput.setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.DelayInput").getString());
		guistate.put("text:DelayInput", DelayInput);
		this.addWidget(this.DelayInput);
		NameInput = new EditBox(this.font, this.leftPos + 30, this.topPos + 19, 118, 18, Component.translatable("gui.superiorstructures.flavor_interface.NameInput")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.NameInput").getString());
				else
					setSuggestion(null);
			}
		...
		NameInput.setSuggestion(Component.translatable("gui.superiorstructures.flavor_interface.NameInput").getString());
		guistate.put("text:NameInput", NameInput);
		this.addWidget(this.NameInput);
		button_input_function = Button.builder(Component.translatable("gui.superiorstructures.flavor_interface.button_input_function"), e -> {
			if (true) {
		...
		button_run_function = Button.builder(Component.translatable("gui.superiorstructures.flavor_interface.button_run_function"), e -> {
			if (true) {
		...
		imagebutton_flavor_buttons_cycle = new ImageButton(this.leftPos + 110, this.topPos + 75, 16, 16,
				new WidgetSprites(ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_cycle.png"), ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_cycle_pressed.png")), e -> {
					if (true) {
		...
		imagebutton_flavor_buttons_question = new ImageButton(this.leftPos + 129, this.topPos + 75, 16, 16,
				new WidgetSprites(ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_question.png"), ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_question_pressed.png")), e -> {
					if (true) {
		...
		imagebutton_flavor_buttons_quill = new ImageButton(this.leftPos + 149, this.topPos + 75, 16, 16,
				new WidgetSprites(ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_quill.png"), ResourceLocation.parse("superiorstructures:textures/screens/flavor_buttons_quill_pressed.png")), e -> {
					if (true) {
		...
		PersistenceBox = Checkbox.builder(Component.translatable("gui.superiorstructures.flavor_interface.PersistenceBox"), this.font).pos(this.leftPos + 44, this.topPos + 120)

				.build();
		guistate.put("checkbox:PersistenceBox", PersistenceBox);
		this.addRenderableWidget(PersistenceBox);
		RedstoneBox = Checkbox.builder(Component.translatable("gui.superiorstructures.flavor_interface.RedstoneBox"), this.font).pos(this.leftPos + 44, this.topPos + 142)
