...
import net.mcreator.superiorstructures.network.TransceiverInterfaceButtonMessage;
...
public class TransceiverInterfaceScreen extends AbstractContainerScreen<TransceiverInterfaceMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("superiorstructures:textures/screens/transceiver_interface.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("superiorstructures:textures/screens/sigilindicator.png"), this.leftPos + 25, this.topPos + 34, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.superiorstructures.transceiver_interface.label_send_and_recieve"), 6, 9, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		button_toggle = Button.builder(Component.translatable("gui.superiorstructures.transceiver_interface.button_toggle"), e -> {
			if (true) {
