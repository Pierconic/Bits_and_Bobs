...
import net.mcreator.superiorstructures.procedures.SetRightPolarityProcedure;
import net.mcreator.superiorstructures.procedures.ResetRightPolarityProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record AscendRightMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<AscendRightMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ascend_right"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(AscendRightMessage.TYPE, AscendRightMessage.STREAM_CODEC, AscendRightMessage::handleData);
	}
}
