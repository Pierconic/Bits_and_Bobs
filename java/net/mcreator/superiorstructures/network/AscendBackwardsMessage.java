...
import net.mcreator.superiorstructures.procedures.SetBackwardsPolarityProcedure;
import net.mcreator.superiorstructures.procedures.ResetBackwardsPolarityProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record AscendBackwardsMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<AscendBackwardsMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ascend_backwards"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(AscendBackwardsMessage.TYPE, AscendBackwardsMessage.STREAM_CODEC, AscendBackwardsMessage::handleData);
	}
}
