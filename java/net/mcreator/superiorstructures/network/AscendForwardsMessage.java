...
import net.mcreator.superiorstructures.procedures.SetForwardsPolarityProcedure;
import net.mcreator.superiorstructures.procedures.ResetForwardsPolarityProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record AscendForwardsMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<AscendForwardsMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ascend_forwards"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(AscendForwardsMessage.TYPE, AscendForwardsMessage.STREAM_CODEC, AscendForwardsMessage::handleData);
	}
}
