...
public class SuperiorstructuresModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, SuperiorstructuresMod.MODID);
	public static final Supplier<AttachmentType<PlayerVariables>> PLAYER_VARIABLES = ATTACHMENT_TYPES.register("player_variables", () -> AttachmentType.serializable(() -> new PlayerVariables()).build());

	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
		SuperiorstructuresMod.addNetworkMessage(PlayerVariablesSyncMessage.TYPE, PlayerVariablesSyncMessage.STREAM_CODEC, PlayerVariablesSyncMessage::handleData);
	}
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			clone.excavationcount = original.excavationcount;
			...
			clone.hookshot_x = original.hookshot_x;
			clone.hookshot_y = original.hookshot_y;
			clone.hookshot_z = original.hookshot_z;
			clone.hookshot_length = original.hookshot_length;
			clone.chainnumber = original.chainnumber;
			...
			if (!event.isWasDeath()) {
				clone.chinashop = original.chinashop;
				clone.jukecooldown = original.jukecooldown;
				clone.TotemCooldown = original.TotemCooldown;
				clone.BoostJumps = original.BoostJumps;
				clone.smashcount = original.smashcount;
				clone.smashtimer = original.smashtimer;
				clone.MushroomDelay = original.MushroomDelay;
				clone.hookshot_linked = original.hookshot_linked;
				clone.hookshot_direction = original.hookshot_direction;
				clone.chain_delay = original.chain_delay;
				clone.hookshot_entity_linked = original.hookshot_entity_linked;
				...
				clone.franklin_cooldown = original.franklin_cooldown;
			}
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "superiorstructures_worldvars";
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "superiorstructures_mapvars";
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "saved_data_sync"));
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		public double chinashop = 0;
		public boolean jukecooldown = false;
		public double excavationcount = 0;
		public double TotemCooldown = 0;
		public double BoostJumps = 0;
		public double DashCooldown = 0;
		public double smashcount = 0;
		...
		public double MushroomDelay = 0;
		public boolean hookshot_linked = false;
		public double hookshot_x = 0;
		public double hookshot_y = 0;
		public double hookshot_z = 0;
		public double hookshot_length = 0;
		public double chainnumber = 0;
		public double hookshot_direction = 0;
		public double chain_delay = 0;
		public boolean hookshot_entity_linked = false;
		...
		public double franklin_cooldown = 0;
		public double singing_sand_cooldown = 0;

		@Override
		public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
			CompoundTag nbt = new CompoundTag();
			nbt.putDouble("chinashop", chinashop);
			nbt.putBoolean("jukecooldown", jukecooldown);
			nbt.putDouble("excavationcount", excavationcount);
			nbt.putDouble("TotemCooldown", TotemCooldown);
			nbt.putDouble("BoostJumps", BoostJumps);
			nbt.putDouble("DashCooldown", DashCooldown);
			nbt.putDouble("smashcount", smashcount);
			nbt.putDouble("smashtimer", smashtimer);
			...
			nbt.putDouble("MushroomDelay", MushroomDelay);
			nbt.putBoolean("hookshot_linked", hookshot_linked);
			nbt.putDouble("hookshot_x", hookshot_x);
			nbt.putDouble("hookshot_y", hookshot_y);
			nbt.putDouble("hookshot_z", hookshot_z);
			nbt.putDouble("hookshot_length", hookshot_length);
			nbt.putDouble("chainnumber", chainnumber);
			nbt.putDouble("hookshot_direction", hookshot_direction);
			nbt.putDouble("chain_delay", chain_delay);
			nbt.putBoolean("hookshot_entity_linked", hookshot_entity_linked);
			...
			nbt.putDouble("franklin_cooldown", franklin_cooldown);
		...
		public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
			chinashop = nbt.getDouble("chinashop");
			jukecooldown = nbt.getBoolean("jukecooldown");
			excavationcount = nbt.getDouble("excavationcount");
			TotemCooldown = nbt.getDouble("TotemCooldown");
			BoostJumps = nbt.getDouble("BoostJumps");
			DashCooldown = nbt.getDouble("DashCooldown");
			smashcount = nbt.getDouble("smashcount");
			smashtimer = nbt.getDouble("smashtimer");
			...
			MushroomDelay = nbt.getDouble("MushroomDelay");
			hookshot_linked = nbt.getBoolean("hookshot_linked");
			hookshot_x = nbt.getDouble("hookshot_x");
			hookshot_y = nbt.getDouble("hookshot_y");
			hookshot_z = nbt.getDouble("hookshot_z");
			hookshot_length = nbt.getDouble("hookshot_length");
			chainnumber = nbt.getDouble("chainnumber");
			hookshot_direction = nbt.getDouble("hookshot_direction");
			chain_delay = nbt.getDouble("chain_delay");
			hookshot_entity_linked = nbt.getBoolean("hookshot_entity_linked");
			...
			franklin_cooldown = nbt.getDouble("franklin_cooldown");
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "player_variables_sync"));
