...
import net.mcreator.superiorstructures.procedures.SetLeftPolarityProcedure;
import net.mcreator.superiorstructures.procedures.ResetLeftPolarityProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record AscendLeftMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<AscendLeftMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ascend_left"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(AscendLeftMessage.TYPE, AscendLeftMessage.STREAM_CODEC, AscendLeftMessage::handleData);
	}
}
