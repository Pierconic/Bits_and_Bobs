...
import net.mcreator.superiorstructures.procedures.TransceiverToggleProcedure;
...
public record TransceiverInterfaceButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<TransceiverInterfaceButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "transceiver_interface_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(TransceiverInterfaceButtonMessage.TYPE, TransceiverInterfaceButtonMessage.STREAM_CODEC, TransceiverInterfaceButtonMessage::handleData);
	}
}
