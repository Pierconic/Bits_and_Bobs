...
import net.mcreator.superiorstructures.procedures.AscendDownwardsOnKeyPressedProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record AscendDownwardsMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<AscendDownwardsMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ascend_downwards"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(AscendDownwardsMessage.TYPE, AscendDownwardsMessage.STREAM_CODEC, AscendDownwardsMessage::handleData);
	}
}
