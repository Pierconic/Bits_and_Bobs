...
import net.mcreator.superiorstructures.procedures.ResetFlavorBlockProcedure;
import net.mcreator.superiorstructures.procedures.PrintInformationProcedure;
import net.mcreator.superiorstructures.procedures.ManuallyTriggerFunctionProcedure;
import net.mcreator.superiorstructures.procedures.FlavorTextInputProcedure;
import net.mcreator.superiorstructures.procedures.ApplyFlavorDisplayNameProcedure;
...
public record FlavorInterfaceButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<FlavorInterfaceButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "flavor_interface_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(FlavorInterfaceButtonMessage.TYPE, FlavorInterfaceButtonMessage.STREAM_CODEC, FlavorInterfaceButtonMessage::handleData);
	}
}
