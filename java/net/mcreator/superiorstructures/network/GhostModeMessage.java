...
import net.mcreator.superiorstructures.procedures.GhostModeOnKeyReleasedProcedure;
import net.mcreator.superiorstructures.procedures.GhostModeOnKeyPressedProcedure;
import net.mcreator.superiorstructures.SuperiorstructuresMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record GhostModeMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<GhostModeMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SuperiorstructuresMod.MODID, "key_ghost_mode"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperiorstructuresMod.addNetworkMessage(GhostModeMessage.TYPE, GhostModeMessage.STREAM_CODEC, GhostModeMessage::handleData);
	}
}
