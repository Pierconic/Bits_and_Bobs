...
public class TempleDecorProcedure {
		...
		if (world.getLevelData().getGameRules().getBoolean(SuperiorstructuresModGameRules.TICK_GENBLOCKS)) {
			...
			if (Math.random() < 0.6) {
				if (Math.random() < 0.4) {
					...
					if (number == 1) {
						world.setBlock(BlockPos.containing(x, y, z), Blocks.POTTED_BAMBOO.defaultBlockState(), 3);
					} else if (number == 2) {
						world.setBlock(BlockPos.containing(x, y, z), Blocks.POTTED_FERN.defaultBlockState(), 3);
					} else if (number == 3) {
						world.setBlock(BlockPos.containing(x, y, z), Blocks.POTTED_JUNGLE_SAPLING.defaultBlockState(), 3);
					} else if (number == 4) {
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.SMALL_LIME_POT.get().defaultBlockState(), 3);
						{
						...
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.TALL_LIME_POT.get().defaultBlockState(), 3);
						{
							Direction _dir = Direction.getRandom(RandomSource.create());
							BlockPos _pos = BlockPos.containing(x, y, z);
							BlockState _bs = world.getBlockState(_pos);
						...
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.LARGE_LIME_POT.get().defaultBlockState(), 3);
						{
							Direction _dir = Direction.getRandom(RandomSource.create());
							BlockPos _pos = BlockPos.containing(x, y, z);
							BlockState _bs = world.getBlockState(_pos);
					...
					if (number == 1) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ lime_candle[candles=3,lit=false]");
					} else if (number == 2) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ lime_candle[candles=2,lit=false]");
					} else if (number == 3) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ lime_candle[candles=3,lit=false]");
						...
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ lime_candle[candles=4,lit=false]");
					} else if (number == 5) {
						...
						if (Math.random() < 0.6) {
							world.setBlock(BlockPos.containing(x, y, z), Blocks.REPEATER.defaultBlockState(), 3);
							{
								Direction _dir = Direction.getRandom(RandomSource.create());
								BlockPos _pos = BlockPos.containing(x, y, z);
								BlockState _bs = world.getBlockState(_pos);
