...
public class GenblockF2A4BuildProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		Genblock6ABuildProcedure.execute(world, (x + 1), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 1), (int) (z + 0))),
				(z + 0));
		Genblock6ABuildProcedure.execute(world, (x + 10), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 10), (int) (z + 0))),
				(z + 0));
		Genblock6ABuildProcedure.execute(world, (x + 1), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 1), (int) (z + 10))),
				(z + 10));
			...
			if (Math.random() < 0.2) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_plain_arch2_r1"));
					if (template != null) {
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_plain_arch2_r1_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 4, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_plain_arch2_r2"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 4, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_plain_arch2_r2_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 4, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
