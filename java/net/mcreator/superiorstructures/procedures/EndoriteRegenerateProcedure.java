...
public class EndoriteRegenerateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!(world instanceof Level _level0 && _level0.hasNeighborSignal(BlockPos.containing(x, y, z)))) {
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.ENDORITE_MESH.get().defaultBlockState(), 3);
			world.levelEvent(2001, BlockPos.containing(x, y, z), Block.getId(SuperiorstructuresModBlocks.ENDORITE_MESH.get().defaultBlockState()));
