...
public class SoulstoneUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 13, 13, 13), e -> true).isEmpty() && count <= 8) {
			if (!(new Object() {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.SOUL, (x + 0.5), (y + 0.5), (z + 0.5), 15, 0.4, 0.4, 4, 0.05);
			}
		}
	}
}
