...
public class GenblockJ2180Procedure {
		...
		if (numerator == 0) {
			SuperiorstructuresMod.queueServerWork(3, () -> {
				if (world instanceof ServerLevel _serverworld) {
					...
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, y + 22, z), BlockPos.containing(x, y + 22, z), new StructurePlaceSettings().setRotation(Rotation.CLOCKWISE_180).setMirror(Mirror.NONE).setIgnoreEntities(false),
								_serverworld.random, 3);
					}
				}
			});
		...
		if (numerator == 0) {
			SuperiorstructuresMod.queueServerWork(5, () -> {
				if (world instanceof ServerLevel _serverworld) {
					...
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, y + 34, z), BlockPos.containing(x, y + 34, z), new StructurePlaceSettings().setRotation(Rotation.CLOCKWISE_180).setMirror(Mirror.NONE).setIgnoreEntities(false),
								_serverworld.random, 3);
					}
				}
			});
