...
public class MoveBlockWestNoSlimeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (WestPushCheckProcedure.execute(world, x, y, z) && !((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.SLIME_BLOCK)) {
			{
