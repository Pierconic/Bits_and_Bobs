...
public class FlameBlast3HitEntityProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.FLAME, x, y, z, Mth.nextInt(RandomSource.create(), 20, 25), 0.1, 0.1, 0.1, 0.15);
		...
		if (Math.random() < 0.9) {
			entity.igniteForSeconds(Mth.nextInt(RandomSource.create(), 7, 10));
		}
	}
}
