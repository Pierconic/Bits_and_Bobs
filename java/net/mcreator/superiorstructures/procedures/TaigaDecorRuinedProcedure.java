...
public class TaigaDecorRuinedProcedure {
			...
			if (Math.random() < 0.6) {
				if (Math.random() < 0.33) {
					...
					if (number == 1) {
						...
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.TALL_VASE.get().defaultBlockState(), 3);
						{
							Direction _dir = Direction.getRandom(RandomSource.create());
							BlockPos _pos = BlockPos.containing(x, y, z);
							BlockState _bs = world.getBlockState(_pos);
						...
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.SPRUCE_VASE.get().defaultBlockState(), 3);
					} else if (number == 9) {
						world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.EMPTY_FLOWER_VASE.get().defaultBlockState(), 3);
					}
				} else {
					...
					if (number == 1) {
						...
						if (Math.random() < 0.6) {
							...
							world.setBlock(BlockPos.containing(x, y, z), Blocks.POTTED_SPRUCE_SAPLING.defaultBlockState(), 3);
						}
					} else if (number == 9) {
						world.setBlock(BlockPos.containing(x, y, z), Blocks.COBWEB.defaultBlockState(), 3);
					}
