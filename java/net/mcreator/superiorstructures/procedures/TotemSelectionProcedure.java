...
public class TotemSelectionProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (number == 0) {
			...
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.TUFF_BRICKS.get().defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x + 1, y, z), SuperiorstructuresModBlocks.TUFF_BRICK_WALL.get().defaultBlockState(), 3);
			{
				String _value = "low";
				BlockPos _pos = BlockPos.containing(x + 1, y, z);
				BlockState _bs = world.getBlockState(_pos);
			...
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.CHISELED_TUFF.get().defaultBlockState(), 3);
		} else if (number == 5) {
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.CRACKED_TUFF_BRICKS.get().defaultBlockState(), 3);
		} else if (number == 6) {
			world.setBlock(BlockPos.containing(x, y, z), (new Object() {
				public BlockState with(BlockState _bs, Direction newValue) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
			...
			}.with(SuperiorstructuresModBlocks.DERPY_CARVED_PUMPKIN.get().defaultBlockState(), Direction.getRandom(RandomSource.create()))), 3);
		} else if (number == 9) {
			world.setBlock(BlockPos.containing(x, y, z), (new Object() {
				public BlockState with(BlockState _bs, Direction newValue) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
