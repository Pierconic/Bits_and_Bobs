...
public class ArtificeryLoot5BoltProcedure {
	public static ItemStack execute() {
		...
		if (Randomizer == 0) {
			...
			ChosenItem = new ItemStack(SuperiorstructuresModItems.BIG_BOLT_CATALYST.get());
		} else if (Randomizer == 2) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.BOOSTER_3_UNPOWERED_CHESTPLATE.get());
		} else if (Randomizer == 3) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.BIG_BOLT_CATALYST.get());
		} else if (Randomizer == 4) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_BOLT_RAIL_1.get());
		} else if (Randomizer == 5) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_PONGORMA_RAIL_1.get());
		} else if (Randomizer == 6) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.POWER_DRILL_3.get());
		} else if (Randomizer == 7) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_BOLT_BLASTER_3.get());
