...
public class AscensionParticlesProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(SuperiorstructuresModMobEffects.ASCENSION)) {
			if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).ascension_timer == 0) {
				{
				...
				{
					SuperiorstructuresModVariables.PlayerVariables _vars = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES);
					_vars.ascension_timer = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).ascension_timer - 1;
					_vars.syncPlayerVariables(entity);
				}
			}
			theta = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).ascension_timer * 0.1;
			radius = 3.5;
