	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity sourceentity) {
		...
		for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 0, (int) (2 + modifier)); index0++) {
			if (world instanceof ServerLevel _level) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(SuperiorstructuresModItems.BRITTLE_CARAPACE.get()));
		...
		for (int index1 = 0; index1 < Mth.nextInt(RandomSource.create(), 1, (int) (1 + modifier)); index1++) {
			if (world instanceof ServerLevel _level) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(SuperiorstructuresModItems.INSECT_FLESH.get()));
				entityToSpawn.setPickUpDelay(10);
				_level.addFreshEntity(entityToSpawn);
			}
		}
