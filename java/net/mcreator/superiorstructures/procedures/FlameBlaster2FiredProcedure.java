...
public class FlameBlaster2FiredProcedure {
					...
					if (!projectileLevel.isClientSide()) {
						Projectile _entityToSpawn = new Object() {
							public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
								AbstractArrow entityToSpawn = new FlameBlaster2ProjectileEntity(SuperiorstructuresModEntities.FLAME_BLASTER_2_PROJECTILE.get(), level) {
									@Override
