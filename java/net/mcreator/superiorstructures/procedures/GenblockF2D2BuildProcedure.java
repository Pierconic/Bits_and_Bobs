...
public class GenblockF2D2BuildProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index3 = 0; index3 < (int) (15); index3++) {
			if ((world.getBlockState(BlockPos.containing(x + extension,
				...
				if ((world.getBlockState(BlockPos.containing(x + extension,
						world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)) - 0, z + 7)))
				...
				if (world
						...
						.isFaceSturdy(world,
								BlockPos.containing(x + extension + 1,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)), z + 7),
								Direction.UP)
						|| world.getBlockState(BlockPos.containing((x + extension) - 1,
								world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)), z + 7))
								.isFaceSturdy(world, BlockPos.containing((x + extension) - 1,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)), z + 7),
										Direction.UP)) {
					world.setBlock(
							BlockPos.containing(x + extension,
				...
				if ((world.getBlockState(BlockPos.containing(x + extension,
						...
						.getBlock() == Blocks.GRASS_BLOCK) {
					if ((world.getBlockState(BlockPos.containing(x + extension,
							world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 6)) - 0, z + 6)))
							.getBlock() == Blocks.SNOW) {
						world.setBlock(
								BlockPos.containing(x + extension,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 6)) - 0, z + 6),
				...
				if ((world.getBlockState(BlockPos.containing(x + extension,
						...
						.getBlock() == Blocks.GRASS_BLOCK) {
					if ((world.getBlockState(BlockPos.containing(x + extension,
							world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 8)) - 0, z + 8)))
							.getBlock() == Blocks.SNOW) {
						world.setBlock(
								BlockPos.containing(x + extension,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 8)) - 0, z + 8),
		...
		GenblockF6DBuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 1))),
				(z + 1));
		GenblockF6DBuildProcedure.execute(world, (x + 10), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 10), (int) (z + 1))),
				(z + 1));
		GenblockF6DBuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 9))),
				(z + 9));
		...
		if (!(world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4))
				...
				&& !((world.getBlockState(
						BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 1, z + 4)))
						.getBlock() == Blocks.WATER
						|| (world.getBlockState(
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)), z + 4)))
								.getBlock() == Blocks.WATER)) {
			if (Math.random() < 0.5) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r1"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r1_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r2"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r2_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
