...
public class BlueRoseEffectProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!(world.canSeeSkyFromBelowWater(BlockPos.containing(x, y + 1, z)) && world instanceof Level _lvl1 && _lvl1.isDay()) && entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).Corruption < 100 && entity instanceof Player) {
			{
