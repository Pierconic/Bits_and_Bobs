...
@EventBusSubscriber
public class PotStorageProcedure {
	@SubscribeEvent
		...
		if (blockstate.is(BlockTags.create(ResourceLocation.parse("forge:pottery")))) {
			if (entity.isShiftKeyDown() && new Object() {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.POOF, (x + 0.5), (y + 1), (z + 0.5), 6, 0.2, 0.2, 0.2, 0.1);
				if (new Object() {
					public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
						if (world instanceof ILevelExtension _ext) {
							IItemHandler _itemHandler = _ext.getCapability(Capabilities.ItemHandler.BLOCK, pos, null);
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.75), (z + 0.5), (new Object() {
				...
				if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable)
					_itemHandlerModifiable.setStackInSlot(0, ItemStack.EMPTY);
				if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
					ItemStack _setstack = itemsave.copy();
					_setstack.setCount((int) (itemsave.getCount() - 1));
