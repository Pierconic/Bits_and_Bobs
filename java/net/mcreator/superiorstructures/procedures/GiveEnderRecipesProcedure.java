...
public class GiveEnderRecipesProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof Player && itemstack.getItem() == SuperiorstructuresModBlocks.TUNEROD_STEM.get().asItem()) {
			if (entity instanceof ServerPlayer _serverPlayer)
		...
		if (entity instanceof Player && itemstack.getItem() == SuperiorstructuresModItems.RAW_ENDORITE.get()) {
			if (entity instanceof ServerPlayer _serverPlayer)
		...
		} else if (itemstack.getItem() == SuperiorstructuresModItems.STRANGE_MACHINERY.get()) {
			if (entity instanceof ServerPlayer _serverPlayer)
