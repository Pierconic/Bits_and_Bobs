...
public class CorruptionSpreadProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(SuperiorstructuresModMobEffects.CORRUPTION) ? _livEnt.getEffect(SuperiorstructuresModMobEffects.CORRUPTION).getDuration() : 0) > 38400) {
			chance_modifier = 3.5;
			time_modifier = 3;
			spires = true;
			evil_eyes = true;
			teeth = true;
			ward_eyes = true;
		} else if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(SuperiorstructuresModMobEffects.CORRUPTION) ? _livEnt.getEffect(SuperiorstructuresModMobEffects.CORRUPTION).getDuration() : 0) > 28800) {
			chance_modifier = 2.3;
			time_modifier = 3;
			evil_eyes = true;
			teeth = true;
			ward_eyes = true;
		} else if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(SuperiorstructuresModMobEffects.CORRUPTION) ? _livEnt.getEffect(SuperiorstructuresModMobEffects.CORRUPTION).getDuration() : 0) > 19200) {
			chance_modifier = 1.6;
			time_modifier = 2;
			teeth = true;
			ward_eyes = true;
		} else if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(SuperiorstructuresModMobEffects.CORRUPTION) ? _livEnt.getEffect(SuperiorstructuresModMobEffects.CORRUPTION).getDuration() : 0) > 8400) {
			chance_modifier = 1;
			time_modifier = 1;
			ward_eyes = true;
		}
