...
public class PowerSaw3DestructionProcedure {
		...
		if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("charge") > 0) {
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
				...
				SuperiorstructuresMod.queueServerWork(6, () -> {
					if ((world.getBlockState(BlockPos.containing(x, y + 3, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x, y + 3, z);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x, y + 3, z), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x, y - 3, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
					...
					if ((world.getBlockState(BlockPos.containing(x + 3, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x + 3, y, z);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x + 3, y, z), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x - 3, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
					...
					if ((world.getBlockState(BlockPos.containing(x, y, z + 3))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x, y, z + 3);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x, y, z + 3), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x, y, z - 3))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
				...
				SuperiorstructuresMod.queueServerWork(8, () -> {
					if ((world.getBlockState(BlockPos.containing(x, y + 4, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x, y + 3, z);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x, y + 4, z), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x, y - 4, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
					...
					if ((world.getBlockState(BlockPos.containing(x + 4, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x + 4, y, z);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x + 4, y, z), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x - 4, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
					...
					if ((world.getBlockState(BlockPos.containing(x, y, z + 4))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
						{
							BlockPos _pos = BlockPos.containing(x, y, z + 4);
							Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x, y, z + 4), null);
							world.destroyBlock(_pos, false);
						}
					}
					if ((world.getBlockState(BlockPos.containing(x, y, z - 4))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/axe")))) {
