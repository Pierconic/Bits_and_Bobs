...
public class BlockOfOldMachineryUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (Math.random() < 0.05) {
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.ACTIVATED_BLOCK_OF_OLD_MACHINERY.get().defaultBlockState(), 3);
