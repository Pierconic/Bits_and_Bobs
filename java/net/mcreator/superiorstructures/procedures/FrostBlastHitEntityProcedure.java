...
public class FrostBlastHitEntityProcedure {
		...
		if (!(entity == sourceentity)) {
			...
			if (entity instanceof Blaze || entity instanceof MagmaCube || entity instanceof WitherSkeleton || entity instanceof Strider || entity instanceof Piglin || entity instanceof ZombifiedPiglin || entity instanceof PiglinBrute
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, Mth.nextInt(RandomSource.create(), 60, 120), 3, false, true));
				entity.setTicksFrozen(360);
			} else {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, Mth.nextInt(RandomSource.create(), 20, 60), 3, false, true));
				entity.setTicksFrozen(360);
			}
		}
	}
