		...
		if (!(!world.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3(x, y, z), 14, 14, 14), e -> true).isEmpty())) {
			{
				...
				BlockState _bs = SuperiorstructuresModBlocks.SOLID_ENDORITE_MEMBRANE.get().defaultBlockState();
					...
					for (Entity entityiterator : _entfound) {
						if (Math.abs(entityiterator.getY() - (y + 0.5)) < distance || distance == 0) {
							if (entityiterator.getY() > y + 0.5 && !(!world.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((x + 0.5), (y + 0.5), (z + 0.5)), 1, 1, 1), e -> true).isEmpty())) {
								if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SuperiorstructuresModBlocks.ENDORITE_MEMBRANE.get()) {
									{
										BlockPos _bp = BlockPos.containing(x, y, z);
										BlockState _bs = SuperiorstructuresModBlocks.SOLID_ENDORITE_MEMBRANE.get().defaultBlockState();
										BlockState _bso = world.getBlockState(_bp);
									...
									if (world instanceof Level _level) {
										if (!_level.isClientSide()) {
											_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:membrane.power")), SoundSource.NEUTRAL, (float) 0.4, 1);
										} else {
											_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:membrane.power")), SoundSource.NEUTRAL, (float) 0.4, 1, false);
										}
									}
								}
							} else {
								if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SuperiorstructuresModBlocks.SOLID_ENDORITE_MEMBRANE.get()) {
									{
										BlockPos _bp = BlockPos.containing(x, y, z);
										BlockState _bs = SuperiorstructuresModBlocks.ENDORITE_MEMBRANE.get().defaultBlockState();
										BlockState _bso = world.getBlockState(_bp);
										for (Property<?> _propertyOld : _bso.getProperties()) {
											Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
											if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
									...
									if (world instanceof Level _level) {
										if (!_level.isClientSide()) {
											_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:membrane.depower")), SoundSource.NEUTRAL, (float) 0.4, 1);
										} else {
											_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:membrane.depower")), SoundSource.NEUTRAL, (float) 0.4, 1, false);
										}
									}
								}
							}
