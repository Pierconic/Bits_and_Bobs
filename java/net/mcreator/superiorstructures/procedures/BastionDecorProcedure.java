...
public class BastionDecorProcedure {
			...
			if (Math.random() < 0.6) {
				...
				if (number == 1) {
					...
					if (world.getBiome(BlockPos.containing(x, y, z)).is(ResourceLocation.parse("soul_sand_valley"))) {
						...
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ red_candle[candles=3,lit=true]");
					} else if (world.getBiome(BlockPos.containing(x, y, z)).is(ResourceLocation.parse("warped_forest"))) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ cyan_candle[candles=3,lit=true]");
					} else {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
					...
					if (world.getBiome(BlockPos.containing(x, y, z)).is(ResourceLocation.parse("soul_sand_valley"))) {
						...
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ red_candle[candles=4,lit=true]");
					} else if (world.getBiome(BlockPos.containing(x, y, z)).is(ResourceLocation.parse("warped_forest"))) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"setblock ~ ~ ~ cyan_candle[candles=4,lit=true]");
					} else {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
					...
					world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.SMALL_DARK_GRAY_POT.get().defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.TALL_DARK_GRAY_POT.get().defaultBlockState(), 3);
					loot = Mth.nextInt(RandomSource.create(), 1, 10);
					if (number == 4) {
						if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
							ItemStack _setstack = new ItemStack(Items.GOLD_NUGGET).copy();
					...
					world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.LARGE_DARK_GRAY_POT.get().defaultBlockState(), 3);
					loot = Mth.nextInt(RandomSource.create(), 1, 10);
					if (number == 4) {
						if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
							ItemStack _setstack = new ItemStack(Items.GOLD_NUGGET).copy();
					...
					world.setBlock(BlockPos.containing(x, y, z), Blocks.POTTED_WITHER_ROSE.defaultBlockState(), 3);
				}
				{
