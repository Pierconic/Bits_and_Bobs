...
public class GoldenGolemUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) >= 50) {
			if (entity instanceof GoldenGolemEntity animatable)
				animatable.setTexture("gilded_golem_new");
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) >= 25) {
			if (entity instanceof GoldenGolemEntity animatable)
				animatable.setTexture("gilded_golem_new_lowcracked");
		} else {
			if (entity instanceof GoldenGolemEntity animatable)
				animatable.setTexture("gilded_golem_new_highcracked");
		}
	}
}
