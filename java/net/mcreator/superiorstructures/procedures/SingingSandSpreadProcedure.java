...
public class SingingSandSpreadProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (1 < ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip2 ? (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getip2) : -1)) {
			if (((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == SuperiorstructuresModBlocks.SINGING_SAND.get()
					|| (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == SuperiorstructuresModBlocks.SPIRALING_SAND.get())
			...
			SuperiorstructuresMod.queueServerWork(2, () -> {
				if (1 < ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip37
						...
						: -1)) {
					if (((world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SuperiorstructuresModBlocks.SINGING_SAND.get()
							|| (world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SuperiorstructuresModBlocks.SPIRALING_SAND.get())
			...
			SuperiorstructuresMod.queueServerWork(4, () -> {
				if (1 < ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip73
						...
						: -1)) {
					if (((world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == SuperiorstructuresModBlocks.SINGING_SAND.get()
							|| (world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == SuperiorstructuresModBlocks.SPIRALING_SAND.get())
