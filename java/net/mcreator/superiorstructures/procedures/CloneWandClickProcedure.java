...
public class CloneWandClickProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof Player _plr ? _plr.getAbilities().instabuild : false) && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SuperiorstructuresModItems.CLONE_WAND.get()) {
			if (entity.isShiftKeyDown()) {
				...
				if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandX == 0 && entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandY == 0 && entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandZ == 0
						&& entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneX == 0 && entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneY == 0
						&& entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneZ == 0) {
					{
						SuperiorstructuresModVariables.PlayerVariables _vars = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES);
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal(((("Anchor 1 Set to [a] [b] [c]".replace("[c]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandZ))).replace("[b]",
								new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandY)))
				...
				} else if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneX == 0 && entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneY == 0
						&& entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneZ == 0) {
					if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandX <= entity.level()
							...
							&& entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandY <= entity.level()
							...
							&& entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).WandZ <= entity.level()
						...
						if (entity instanceof Player _player && !_player.level().isClientSide())
							_player.displayClientMessage(Component.literal(((("Anchor 2 Set to [a] [b] [c]".replace("[c]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneZ)))
									.replace("[b]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneY)))
									.replace("[a]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneX)))), false);
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.allay.hurt")), SoundSource.NEUTRAL, 1, 1);
							} else {
										...
										((((((((("clone [a] [b] [c] [d] [e] [f] [g] [h] [i]".replace("[i]", new java.text.DecimalFormat("####").format(entity.level()
												...
												.replace("[g]",
														new java.text.DecimalFormat("####").format(entity.level()
																.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(5)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity))
																.getBlockPos().getX())))
												.replace("[f]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneZ)))
												.replace("[e]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneY)))
												.replace("[d]", new java.text.DecimalFormat("####").format(entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).CloneX)))
