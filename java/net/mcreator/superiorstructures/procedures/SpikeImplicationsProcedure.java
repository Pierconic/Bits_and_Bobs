...
public class SpikeImplicationsProcedure {
	public static void execute(LevelAccessor world, double x, double z) {
		...
		for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 4, 8); index0++) {
			...
			if (((world.getBlockState(BlockPos.containing(x + sx, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + sx), (int) (z + sz)) - 1, z + sz))).getBlock() == Blocks.GRASS_BLOCK
				...
				world.setBlock(BlockPos.containing(x + sx, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + sx), (int) (z + sz)), z + sz), Blocks.CHISELED_RED_SANDSTONE.defaultBlockState(), 3);
				SpikeSelectionProcedure.execute(world, x + sx, z + sz);
			}
		}
	}
}
