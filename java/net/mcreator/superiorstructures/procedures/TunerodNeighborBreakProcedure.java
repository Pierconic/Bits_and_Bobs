...
public class TunerodNeighborBreakProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		SuperiorstructuresMod.queueServerWork(2, () -> {
			if (!((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.TUNEROD_STEM.get()) && !world.getBlockState(BlockPos.containing(x, y - 1, z)).canOcclude()
				...
				}.getDirection(BlockPos.containing(x, y, z))) && !((world.getBlockState(BlockPos.containing(x, y - 0, z + 1))).getBlock() == SuperiorstructuresModBlocks.TUNEROD_STEM.get())) {
					{
						BlockPos _pos = BlockPos.containing(x, y, z);
						Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x + 0.5, y + 0.5, z + 0.5), null);
						world.destroyBlock(_pos, false);
				...
				}.getDirection(BlockPos.containing(x, y, z))) && !((world.getBlockState(BlockPos.containing(x - 1, y - 0, z))).getBlock() == SuperiorstructuresModBlocks.TUNEROD_STEM.get())) {
					{
						BlockPos _pos = BlockPos.containing(x, y, z);
						Block.dropResources(world.getBlockState(_pos), world, BlockPos.containing(x + 0.5, y + 0.5, z + 0.5), null);
						world.destroyBlock(_pos, false);
