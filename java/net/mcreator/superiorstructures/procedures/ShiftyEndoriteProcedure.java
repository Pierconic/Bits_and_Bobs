	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (Math.random() < 0.5) {
			...
			if (direction == 0 && (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == Blocks.END_STONE) {
				...
				world.setBlock(BlockPos.containing(x, y - 1, z), SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState(), 3);
				world.levelEvent(2001, BlockPos.containing(x, y, z), Block.getId(SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState()));
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:endoritebreak")), SoundSource.BLOCKS, 1, 1);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:endoritebreak")), SoundSource.BLOCKS, 1, 1, false);
					}
				}
				...
				world.setBlock(BlockPos.containing(x, y, z), Blocks.END_STONE.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x + 1, y, z), SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState(), 3);
				world.levelEvent(2001, BlockPos.containing(x, y, z), Block.getId(SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState()));
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:endoritebreak")), SoundSource.BLOCKS, 1, 1);
				...
				world.setBlock(BlockPos.containing(x, y, z), Blocks.END_STONE.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x, y, z - 1), SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState(), 3);
				world.levelEvent(2001, BlockPos.containing(x, y, z), Block.getId(SuperiorstructuresModBlocks.ENDORITE_ORE.get().defaultBlockState()));
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:endoritebreak")), SoundSource.BLOCKS, 1, 1);
