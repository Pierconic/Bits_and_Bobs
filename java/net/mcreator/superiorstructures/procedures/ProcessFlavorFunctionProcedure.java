...
public class ProcessFlavorFunctionProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (function_body.startsWith("/")) {
		...
		} else if (function_body.startsWith("vspread")) {
			VerticalSpreadFunctionProcedure.execute(world, x, y, z, false, false, false, false, false, false, false, false, 0, 0, 0, 0, 0, 0, 0, 0, "");
			...
			SpreadFunctionProcedure.execute(world, x, y, z);
		} else if (function_body.startsWith("map")) {
			MapFunctionProcedure.execute(world, x, y, z);
		} else if (function_body.startsWith("paint")) {
			PaintFunctionProcedure.execute(world, x, y, z);
