...
public class EssenceLeechProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false) && entity instanceof LivingEntity) {
			...
			entity.hurt(new DamageSource(world.holderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("superiorstructures:essence_damage")))), (float) (2 + armor));
