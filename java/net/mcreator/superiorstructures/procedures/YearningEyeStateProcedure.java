...
public class YearningEyeStateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (hypotenuse < 8) {
			...
			if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).Eyeball_Agitation < 10
					&& (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SuperiorstructuresModItems.YEARNING_EYE.get()) {
				{
					SuperiorstructuresModVariables.PlayerVariables _vars = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES);
					_vars.Eyeball_Agitation = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).Eyeball_Agitation + 1;
					_vars.syncPlayerVariables(entity);
				}
			} else if (entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).Eyeball_Agitation > 0
					&& !((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SuperiorstructuresModItems.YEARNING_EYE.get())) {
				{
					SuperiorstructuresModVariables.PlayerVariables _vars = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES);
					_vars.Eyeball_Agitation = entity.getData(SuperiorstructuresModVariables.PLAYER_VARIABLES).Eyeball_Agitation - 1;
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SuperiorstructuresModItems.YEARNING_EYE.get()) {
				{
				...
				if (hypotenuse < 128) {
						...
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x + ((entity.getX() - dx) / hypotenuse) * (-15), y, z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.near")), SoundSource.NEUTRAL, 1, 1);
							} else {
								_level.playLocalSound((x + ((entity.getX() - dx) / hypotenuse) * (-15)), y, (z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.near")), SoundSource.NEUTRAL, 1, 1, false);
							}
						}
						{
							final String _tagName = "Pulse";
					...
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Pulse") > 80) {
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x + ((entity.getX() - dx) / hypotenuse) * (-15), y, z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.closer")), SoundSource.NEUTRAL, 1, 1);
							} else {
								_level.playLocalSound((x + ((entity.getX() - dx) / hypotenuse) * (-15)), y, (z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.closer")), SoundSource.NEUTRAL, 1, 1, false);
							}
						}
						{
							final String _tagName = "Pulse";
					...
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Pulse") > 120) {
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x + ((entity.getX() - dx) / hypotenuse) * (-15), y, z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.far")), SoundSource.NEUTRAL, 1, 1);
							} else {
								_level.playLocalSound((x + ((entity.getX() - dx) / hypotenuse) * (-15)), y, (z + ((entity.getZ() - dz) / hypotenuse) * (-15)),
										BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:yearning_eye.far")), SoundSource.NEUTRAL, 1, 1, false);
							}
						}
						{
							final String _tagName = "Pulse";
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SuperiorstructuresModItems.YEARNING_EYE.get()) {
			if (hypotenuse < 8 || 0 < (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Energy")) {
				if (0 == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Energy")) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:eye.charge")), SoundSource.NEUTRAL, 1, 1);
						} else {
							_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:eye.charge")), SoundSource.NEUTRAL, 1, 1, false);
						}
					}
				}
				{
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Energy") >= 130) {
				if (entity instanceof LivingEntity _entity) {
					ItemStack _setstack = new ItemStack(SuperiorstructuresModItems.EMPTY_EYE.get()).copy();
