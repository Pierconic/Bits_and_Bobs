...
public class GenblockF2DBuildProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index3 = 0; index3 < (int) (15); index3++) {
			if ((world.getBlockState(BlockPos.containing(x + extension,
				...
				if ((world.getBlockState(BlockPos.containing(x + extension,
						...
						.getBlock() == Blocks.GRASS_BLOCK) {
					if ((world.getBlockState(BlockPos.containing(x + extension,
							world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 6)) - 0, z + 7)))
							.getBlock() == Blocks.SNOW) {
						world.setBlock(
								BlockPos.containing(x + extension,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 6)) - 0, z + 7),
				...
				if ((world.getBlockState(BlockPos.containing(x + extension,
						...
						.getBlock() == Blocks.GRASS_BLOCK) {
					if ((world.getBlockState(BlockPos.containing(x + extension,
							world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 8)) - 0, z + 7)))
							.getBlock() == Blocks.SNOW) {
						world.setBlock(
								BlockPos.containing(x + extension,
										world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 8)) - 0, z + 7),
		...
		GenblockF6D2BuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 1))),
				(z + 1));
		GenblockF6D2BuildProcedure.execute(world, (x + 10),
				(world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 10), (int) (z + 1))), (z + 1));
		GenblockF6D2BuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 10))),
				(z + 10));
		GenblockF6D2BuildProcedure.execute(world, (x + 10),
		...
		if (!(world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 9), (int) (z + 12)) > 2
			...
			if (Math.random() < 0.2) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r3"));
					if (template != null) {
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r3_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r4"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_tundra_arch1_r4_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3, z + 4),
								new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
