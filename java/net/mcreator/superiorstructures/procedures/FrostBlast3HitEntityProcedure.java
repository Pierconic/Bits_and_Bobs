...
public class FrostBlast3HitEntityProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (!(entity == sourceentity)) {
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.SNOWFLAKE, x, y, z, Mth.nextInt(RandomSource.create(), 20, 30), 0.1, 0.1, 0.1, 0.05);
			...
			if (entity instanceof Blaze || entity instanceof MagmaCube || entity instanceof WitherSkeleton || entity instanceof Strider || entity instanceof Piglin || entity instanceof ZombifiedPiglin || entity instanceof PiglinBrute
				...
				entity.setTicksFrozen(720);
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, Mth.nextInt(RandomSource.create(), 300, 450), 2, false, true));
			} else {
				entity.setTicksFrozen(720);
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, Mth.nextInt(RandomSource.create(), 240, 360), 2, false, true));
			}
		}
	}
}
