...
public class AncientMachinerySenseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!(!world.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((x + 0.5), (y + 0.5), (z + 0.5)), 12, 12, 12), e -> true).isEmpty()
								...
								}.compareDistOf((x + 0.5), (y + 0.5), (z + 0.5))).findFirst().orElse(null)).getZ()))).is(BlockTags.create(ResourceLocation.parse("minecraft:dampens_vibrations")))))) {
			{
				...
				BlockState _bs = SuperiorstructuresModBlocks.BLOCK_OF_ANCIENT_MACHINERY.get().defaultBlockState();
			...
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.ACTIVATED_BLOCK_OF_ANCIENT_MACHINERY.get().defaultBlockState(), 3);
		}
	}
}
