...
public class CanticleGrowthProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		double randy = 0;
		if (blockstate.getBlock() == SuperiorstructuresModBlocks.BLOOMING_CANTICLE.get()) {
			if (Math.random() < 0.5 && ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()
					|| (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()
					|| (world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()
					|| (world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()
					|| (world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()
					|| (world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get())) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.tunnel")), SoundSource.NEUTRAL, (float) 0.6, 1);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.tunnel")), SoundSource.NEUTRAL, (float) 0.6, 1, false);
					}
				}
				while ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SuperiorstructuresModBlocks.BLOOMING_CANTICLE.get()) {
					randy = Mth.nextInt(RandomSource.create(), 0, 5);
					if (randy == 0 && (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
						...
						}
						{
							...
							BlockState _bs = SuperiorstructuresModBlocks.BLOOMING_CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
							for (Property<?> _propertyOld : _bso.getProperties()) {
								Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
								if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
					...
					} else if (randy == 1 && (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
					...
					} else if (randy == 2 && (world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
					...
					} else if (randy == 3 && (world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
					...
					} else if (randy == 4 && (world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
					...
					} else if (randy == 5 && (world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == SuperiorstructuresModBlocks.CANTICLE.get()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = SuperiorstructuresModBlocks.CANTICLE.get().defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
			...
			} else if (!((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
					&& ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock().getStateDefinition().getProperty("face") instanceof EnumProperty _getep45
							...
							: "").equals("CEILING")
					|| (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
							&& ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock().getStateDefinition().getProperty("face") instanceof EnumProperty _getep49
									...
									: "").equals("FLOOR")
					|| (world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
					...
					|| (world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
							...
							&& ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock().getStateDefinition().getProperty("facing") instanceof EnumProperty _getep61
									...
									: "").equals("east")
					|| (world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.emerge")), SoundSource.NEUTRAL, (float) 0.6, 1);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.emerge")), SoundSource.NEUTRAL, (float) 0.6, 1, false);
					}
				}
				...
				if (world.isEmptyBlock(BlockPos.containing(x + 0, y + 1, z + 0))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.getRandom(RandomSource.create()))), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "floor"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if (world.isEmptyBlock(BlockPos.containing(x + 0, y - 1, z + 0))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.getRandom(RandomSource.create()))), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "ceiling"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if (world.isEmptyBlock(BlockPos.containing(x + 1, y + 0, z + 0))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.EAST)), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "wall"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if (world.isEmptyBlock(BlockPos.containing(x - 1, y + 0, z + 0))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.WEST)), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "wall"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if (world.isEmptyBlock(BlockPos.containing(x + 0, y + 0, z - 1))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.NORTH)), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "wall"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if (world.isEmptyBlock(BlockPos.containing(x + 0, y + 0, z + 1))) {
					{
						...
						}.with(SuperiorstructuresModBlocks.LYDIAN_PETALS.get().defaultBlockState(), Direction.SOUTH)), "blockstate", Mth.nextInt(RandomSource.create(), 1, 3))), "face", "wall"));
						BlockState _bso = world.getBlockState(_bp);
						for (Property<?> _propertyOld : _bso.getProperties()) {
							Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
							if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
				...
				if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
		...
		} else if (blockstate.getBlock() == SuperiorstructuresModBlocks.CANTICLE.get() && ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == SuperiorstructuresModBlocks.LYDIAN_PETALS.get()
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.retract")), SoundSource.NEUTRAL, (float) 0.6, 1);
				} else {
					_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("superiorstructures:lydian.retract")), SoundSource.NEUTRAL, (float) 0.6, 1, false);
				}
			}
		...
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).is(BlockTags.create(ResourceLocation.parse("forge:canticle_corruptable")))) {
			...
			{
				BlockPos _bp = BlockPos.containing(x, y + 1, z);
				BlockState _bs = SuperiorstructuresModBlocks.ROTTING_END_STONE.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Property<?> _propertyOld : _bso.getProperties()) {
					Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
					if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
