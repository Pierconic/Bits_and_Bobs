...
@EventBusSubscriber
public class FrostTrinketAttackProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		double trinkets = 0;
		double modifier = 0;
		if (sourceentity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(SuperiorstructuresModItems.FROST_TRINKET.get())) : false) {
			amps = 1;
			...
			if (Math.random() < trinkets * 0.25) {
				entity.setTicksFrozen((int) (320 * amps));
