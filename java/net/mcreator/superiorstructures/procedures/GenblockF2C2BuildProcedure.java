...
public class GenblockF2C2BuildProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
			...
			if ((world.getBlockState(BlockPos.containing(x + extension,
				...
				if (Math.random() < 0.9) {
					world.setBlock(
							BlockPos.containing(x + extension,
									world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)) - 1, z + 7),
							Blocks.PACKED_MUD.defaultBlockState(), 3);
				} else {
					world.setBlock(
							BlockPos.containing(x + extension,
									world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)) - 1, z + 7),
				...
				if (world
					...
					world.setBlock(
							BlockPos.containing(x + extension,
									world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + extension), (int) (z + 7)), z + 7),
							Blocks.ACACIA_SLAB.defaultBlockState(), 3);
				}
				if ((world.getBlockState(BlockPos.containing(x + extension,
		...
		GenblockF6CBuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 1))),
				(z + 1));
		GenblockF6CBuildProcedure.execute(world, (x + 10), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 10), (int) (z + 1))),
				(z + 1));
		GenblockF6CBuildProcedure.execute(world, (x + 0), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 0), (int) (z + 9))),
				(z + 9));
		GenblockF6CBuildProcedure.execute(world, (x + 10),
			...
			if (Math.random() < 0.2) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_savanna_arch1_r1"));
					if (template != null) {
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_savanna_arch1_r1_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_savanna_arch1_r2"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager()
							.getOrCreate(ResourceLocation.fromNamespaceAndPath("superiorstructures", "village_savanna_arch1_r2_alt"));
					if (template != null) {
						template.placeInWorld(_serverworld,
								BlockPos.containing(x + 6, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + 6), (int) (z + 4)) - 3,
										z + 4),
