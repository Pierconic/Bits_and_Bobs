...
public class JawstoneActivateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("forge:illager_hated"))) || entity instanceof Player && !(new Object() {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = EntityType.EVOKER_FANGS.spawn(_level, BlockPos.containing(x + 0.5, y + 1, z + 0.5), MobSpawnType.MOB_SUMMONED);
			...
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.ACTIVATED_JAWSTONE.get().defaultBlockState(), 3);
		}
	}
}
