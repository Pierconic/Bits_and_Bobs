...
public class StrangeMachinerySenseProcedure {
		...
		if (found == false) {
			{
				...
				BlockState _bs = SuperiorstructuresModBlocks.BLOCK_OF_STRANGE_MACHINERY.get().defaultBlockState();
			...
			world.setBlock(BlockPos.containing(x, y, z), SuperiorstructuresModBlocks.ACTIVATED_BLOCK_OF_STRANGE_MACHINERY.get().defaultBlockState(), 3);
		}
	}
}
