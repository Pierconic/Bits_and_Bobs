...
public class TempleRuinProcedure {
					...
					for (int index2 = 0; index2 < 24; index2++) {
						...
						if ((world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz))).getBlock() == Blocks.COBBLESTONE) {
							if (Math.random() < 0.05 && !((world.getBlockState(BlockPos.containing(x + sx + 1, y + sy, z + sz))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing((x + sx) - 1, y + sy, z + sz))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, y + sy, (z + sz) - 1))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz + 1))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, y + sy + 1, z + sz))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, (y + sy) - 1, z + sz))).getBlock() == Blocks.SLIME_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx + 1, y + sy, z + sz))).getBlock() == Blocks.HONEY_BLOCK)
									&& !((world.getBlockState(BlockPos.containing((x + sx) - 1, y + sy, z + sz))).getBlock() == Blocks.HONEY_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, y + sy, (z + sz) - 1))).getBlock() == Blocks.HONEY_BLOCK)
									&& !((world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz + 1))).getBlock() == Blocks.HONEY_BLOCK)
							...
							{
								BlockPos _bp = BlockPos.containing(x + sx, y + sy, z + sz);
								BlockState _bs = (Blocks.REDSTONE_TORCH.getStateDefinition().getProperty("lit") instanceof BooleanProperty _withbp111
										? Blocks.REDSTONE_TORCH.defaultBlockState().setValue(_withbp111, false)
							...
							{
								BlockPos _bp = BlockPos.containing(x + sx, y + sy, z + sz);
								BlockState _bs = (Blocks.REDSTONE_WALL_TORCH.getStateDefinition().getProperty("lit") instanceof BooleanProperty _withbp115
										? Blocks.REDSTONE_WALL_TORCH.defaultBlockState().setValue(_withbp115, false)
						...
						if ((world.getBlockState(BlockPos.containing(x + sx, y + sy + 1, z + sz)).canOcclude() || world.getBlockState(BlockPos.containing(x + sx + 1, y + sy, z + sz)).canOcclude()
								...
								|| world.getBlockState(BlockPos.containing((x + sx) - 1, y + sy, z + sz)).canOcclude())
								&& !(world.getBlockState(BlockPos.containing(x + sx + 1, y + sy, z + sz))).is(BlockTags.create(ResourceLocation.parse("forge:break_preventable")))
								&& !(world.getBlockState(BlockPos.containing((x + sx) - 1, y + sy, z + sz))).is(BlockTags.create(ResourceLocation.parse("forge:break_preventable")))
								&& !(world.getBlockState(BlockPos.containing(x + sx, y + sy, (z + sz) - 1))).is(BlockTags.create(ResourceLocation.parse("forge:break_preventable")))
								&& !(world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz + 1))).is(BlockTags.create(ResourceLocation.parse("forge:break_preventable")))
						...
						if (world.isEmptyBlock(BlockPos.containing(x + sx + 1, y + sy, z + sz)) && number >= 1 && number <= 3 && world.getBlockState(BlockPos.containing(x, y, z)).isFaceSturdy(world, BlockPos.containing(x, y, z), Direction.EAST)) {
							if (Math.random() < 0.2) {
								...
								&& world.getBlockState(BlockPos.containing(x, y, z)).isFaceSturdy(world, BlockPos.containing(x, y, z), Direction.WEST)) {
							if (Math.random() < 0.1) {
								world.setBlock(BlockPos.containing((x + sx) - 1, y + sy, z + sz), (new Object() {
									public BlockState with(BlockState _bs, Direction newValue) {
										Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
								...
								&& world.getBlockState(BlockPos.containing(x, y, z)).isFaceSturdy(world, BlockPos.containing(x, y, z), Direction.NORTH)) {
							if (Math.random() < 0.2) {
								...
								&& world.getBlockState(BlockPos.containing(x, y, z)).isFaceSturdy(world, BlockPos.containing(x, y, z), Direction.SOUTH)) {
							if (Math.random() < 0.2) {
								world.setBlock(BlockPos.containing(x + sx, y + sy, z + sz + 1), (new Object() {
									public BlockState with(BlockState _bs, Direction newValue) {
										Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
