...
public class ArtificeryLoot3FrostProcedure {
	public static ItemStack execute() {
		...
		if (Randomizer == 0) {
			...
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_FROST_RAIL_1.get());
		} else if (Randomizer == 2) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_FROST_BLASTER_2.get());
		} else if (Randomizer == 3) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.BIG_FROST_CATALYST.get());
			...
			ChosenItem = new ItemStack(SuperiorstructuresModItems.DEACTIVATED_FROST_BLASTER_1.get());
		} else if (Randomizer == 8) {
			ChosenItem = new ItemStack(SuperiorstructuresModItems.FROST_CATALYST.get());
