...
public class GenblockF9SpreadProcedure {
			...
			if (Math.random() < 0.3) {
				if (Math.random() < 0.3) {
					if (Math.random() < 0.2) {
						...
						world.setBlock(BlockPos.containing(x, y, z), Blocks.WITHER_ROSE.defaultBlockState(), 3);
					}
				} else {
					{
						BlockPos _bp = BlockPos.containing(x, y - 1, z);
				...
				if (Math.random() < 0.7) {
					...
					if (Math.random() < 0.25) {
						if (Math.random() < 0.3) {
							{
								BlockPos _bp = BlockPos.containing(x - 2, y - 1, z);
								BlockState _bs = Blocks.SOUL_SOIL.defaultBlockState();
								BlockState _bso = world.getBlockState(_bp);
								for (Property<?> _propertyOld : _bso.getProperties()) {
									Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
				...
				if (Math.random() < 0.7) {
					...
					if (Math.random() < 0.25) {
						if (Math.random() < 0.3) {
							{
								BlockPos _bp = BlockPos.containing(x, y - 1, z + 2);
								BlockState _bs = Blocks.SOUL_SOIL.defaultBlockState();
								BlockState _bso = world.getBlockState(_bp);
								for (Property<?> _propertyOld : _bso.getProperties()) {
									Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
