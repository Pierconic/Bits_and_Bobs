...
public class TuneRodGrowthProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SuperiorstructuresModBlocks.TUNEROD_STEM.get()) {
			if (((world.getBlockState(BlockPos.containing(x, y, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip3 ? (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getip3) : -1) == 0) {
				if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 1)), 3);
				}
				...
				if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 2)), 3);
				}
				...
				if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
					if (Math.random() < 0.3 || ((world.getBlockState(BlockPos.containing(x, y - 3, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip16
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 7)), 3);
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 5)), 3);
					} else {
						world.setBlock(BlockPos.containing(x, y + 1, z), (new Object() {
							public BlockState with(BlockState _bs, String _property, int _newValue) {
								Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty(_property);
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 3)), 3);
				}
				...
				if (Math.random() < 0.5) {
					if (world.isEmptyBlock(BlockPos.containing(x + 1, y + 0, z)) && world.isEmptyBlock(BlockPos.containing(x - 1, y + 0, z))) {
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.SOUTH)), "blockstate", 6)), 3);
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.EAST)), "blockstate", 4)), 3);
						world.setBlock(BlockPos.containing(x - 1, y, z), (new Object() {
							public BlockState with(BlockState _bs, String _property, int _newValue) {
								Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty(_property);
								return _prop instanceof IntegerProperty _ip && _prop.getPossibleValues().contains(_newValue) ? _bs.setValue(_ip, _newValue) : _bs;
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.WEST)), "blockstate", 4)), 3);
					}
				} else {
					if (world.isEmptyBlock(BlockPos.containing(x + 1, y + 0, z)) && world.isEmptyBlock(BlockPos.containing(x - 1, y + 0, z))) {
						world.setBlock(BlockPos.containing(x, y, z), (new Object() {
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.EAST)), "blockstate", 6)), 3);
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.SOUTH)), "blockstate", 4)), 3);
						world.setBlock(BlockPos.containing(x, y, z - 1), (new Object() {
							public BlockState with(BlockState _bs, String _property, int _newValue) {
								Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty(_property);
								return _prop instanceof IntegerProperty _ip && _prop.getPossibleValues().contains(_newValue) ? _bs.setValue(_ip, _newValue) : _bs;
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), Direction.NORTH)), "blockstate", 4)), 3);
					}
				}
				...
				if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
					if (Math.random() < 0.3 || ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip62
						...
						}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 9)), 3);
					} else {
						world.setBlock(BlockPos.containing(x, y + 1, z), (new Object() {
							public BlockState with(BlockState _bs, String _property, int _newValue) {
								Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty(_property);
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 8)), 3);
				}
				...
				if (Math.random() < 0.5) {
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 10)), Direction.NORTH)), 3);
				} else {
					world.setBlock(BlockPos.containing(x, y, z), (new Object() {
						public BlockState with(BlockState _bs, Direction newValue) {
							Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
					...
					}.with(SuperiorstructuresModBlocks.TUNEROD_STEM.get().defaultBlockState(), "blockstate", 10)), Direction.WEST)), 3);
				}
			}
		}
	}
